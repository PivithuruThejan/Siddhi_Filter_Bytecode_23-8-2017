...
public class FilterOptimizingTestCase2 {
    ...
    @Test
    public void testForBoolExpressionExecutorAndFunctionExecutor()
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                ...
                "BattingStyle string,AggressiveBattingStyle bool,AllRounder bool);";
        String query = "@info(name = 'query1') from players[instanceOfBoolean(AggressiveBattingStyle) and instanceOfDouble(TestAverage) ]" +
        ...
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 33.0, 62.5f, 32.5f, 80.5f, 16.3f, 116.3f, "LHB", false, false};
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", 47.6, 65.3f, 42.1f, 83.4f, 26.3f, 136.3f, "RHB", true, true};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53.7, 57.4f, 36.5f, 85.5f, 36.3f, 146.7f, "RHB", true, true};
        ...
        Object[] o6 = new Object[]{"Kane Williamson", "New Zealand", 54.2, 48.7f, 45.1f, 79.3f, 29.3f, 119.3f, "RHB", false, false};
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 63.3, 51.5f, 50.5f, 82.7f, 16.3f, 112.2f, "RHB", false, false};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 51.9, 62.1f, 52.5f, 101.5f, 33.3f, 156.3f, "RHB", true, false};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 47.8, 47.5f, 52.5f, 86.5f, 26.3f, 127.3f, "RHB", false, false};
    ...
    @Test
    public void testForInstanceOfBooleanFunctionExecutorr()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " double,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string,AggressiveBattingStyle bool,AllRounder bool);";
        String query = "@info(name = 'query1') from players[instanceOfBoolean(AggressiveBattingStyle)]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForInstanceOfDoubleFunctionExecutorr()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " double,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string,AggressiveBattingStyle bool,AllRounder bool);";
        String query = "@info(name = 'query1') from players[instanceOfDouble(TestAverage)]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForInstanceOfFloatFunctionExecutorr()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " double,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string,AggressiveBattingStyle bool,AllRounder bool);";
        String query = "@info(name = 'query1') from players[instanceOfFloat(TestStrikeRate)]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForInstanceOfIntegerFunctionExecutorr()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                ...
                "BattingStyle string,AggressiveBattingStyle bool,AllRounder bool);";
        String query = "@info(name = 'query1') from players[instanceOfInteger(TestAverage)]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
        ...
        siddhiAppRuntime.start();
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 33, 62.5f, 32.5f, 80.5f, 16.3f, 116.3f, "LHB", false, false};
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", 47, 65.3f, 42.1f, 83.4f, 26.3f, 136.3f, "RHB", true, true};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53, 57.4f, 36.5f, 85.5f, 36.3f, 146.7f, "RHB", true, true};
        Object[] o4 = new Object[]{"Joe Root", "England", 55, 52.5f, 52.7f, 88.3f, 24.9f, 128.3f, "RHB", false, false};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 41, 72.5f, 43.6f, 90.7f, 22.3f, 133.8f, "LHB", true, true};
        Object[] o6 = new Object[]{"Kane Williamson", "New Zealand", 54, 48.7f, 45.1f, 79.3f, 29.3f, 119.3f, "RHB", false, false};
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 63, 51.5f, 50.5f, 82.7f, 16.3f, 112.2f, "RHB", false, false};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 51, 62.1f, 52.5f, 101.5f, 33.3f, 156.3f, "RHB", true, false};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 47, 47.5f, 52.5f, 86.5f, 26.3f, 127.3f, "RHB", false, false};
        Object[] o10 = new Object[]{"Virat Kholi", "India", 52, 66.5f, 53.5f, 89.5f, 30.3f, 136.3f, "RHB", true, false};
        Object[] o11 = new Object[]{"Rohit Sharma", "India", 32, 62.5f, 42.5f, 93.5f, 26.3f, 141.3f, "RHB", true, false};
        for (int i = 1; i <= COUNT; i++) {
            inputHandler.send(o1);
            inputHandler.send(o2);
            inputHandler.send(o3);
    ...
    @Test
    public void testForInstanceOfLongFunctionExecutorr()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " int,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string,AggressiveBattingStyle bool,AllRounder bool);";
        String query = "@info(name = 'query1') from players[instanceOfLong(TestAverage)]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
        ...
        siddhiAppRuntime.start();
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 33l, 62.5f, 32.5f, 80.5f, 16.3f, 116.3f, "LHB", false, false};
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", 47l, 65.3f, 42.1f, 83.4f, 26.3f, 136.3f, "RHB", true, true};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53l, 57.4f, 36.5f, 85.5f, 36.3f, 146.7f, "RHB", true, true};
        Object[] o4 = new Object[]{"Joe Root", "England", 55l, 52.5f, 52.7f, 88.3f, 24.9f, 128.3f, "RHB", false, false};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 41l, 72.5f, 43.6f, 90.7f, 22.3f, 133.8f, "LHB", true, true};
        Object[] o6 = new Object[]{"Kane Williamson", "New Zealand", 54l, 48.7f, 45.1f, 79.3f, 29.3f, 119.3f, "RHB", false, false};
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 63l, 51.5f, 50.5f, 82.7f, 16.3f, 112.2f, "RHB", false, false};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 51l, 62.1f, 52.5f, 101.5f, 33.3f, 156.3f, "RHB", true, false};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 47l, 47.5f, 52.5f, 86.5f, 26.3f, 127.3f, "RHB", false, false};
        Object[] o10 = new Object[]{"Virat Kholi", "India", 52l, 66.5f, 53.5f, 89.5f, 30.3f, 136.3f, "RHB", true, false};
        Object[] o11 = new Object[]{"Rohit Sharma", "India", 32l, 62.5f, 42.5f, 93.5f, 26.3f, 141.3f, "RHB", true, false};
        for (int i = 1; i <= COUNT; i++) {
            inputHandler.send(o1);
            inputHandler.send(o2);
            inputHandler.send(o3);
    ...
    @Test
    public void testForInstanceOfStringFunctionExecutorr()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " int,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string,AggressiveBattingStyle bool,AllRounder bool);";
        String query = "@info(name = 'query1') from players[instanceOfString(playerName)]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForAddDoubleExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        siddhiAppRuntime.start();
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 32, 62.5f, 32.5f, 80.5f, 16.3f, 116.3f, "LHB"};
    ...
    @Test
    public void testForSubtractDoubleExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " double,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(5.0 >50.0 - TestAverage )]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForSubtractFloatExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                ...
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(5.0 >50f - TestAverage )]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForSubtractIntegerExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " int,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(5.0 >50 - TestAverage )]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForSubtractLongExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                ...
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(5.0 >50l - TestAverage )]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForModDoubleExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testForModFloatExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testForModIntegerExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testForModLongExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " long,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(60l % TestAverage>10.0 )]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForMultiplyDoubleExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testForDivideDoubleExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testForDivideFloatExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " float,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[( TestAverage / 5f > 9.0 )]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForDivideIntegerExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " int,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[( TestAverage / 5 > 9.0 )]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
        ...
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 63, 51.5f, 50.5f, 82.7f, 16.3f, 112.2f, "RHB"};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 51, 62.1f, 52.5f, 101.5f, 33.3f, 156.3f, "RHB"};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 57, 47.5f, 52.5f, 86.5f, 26.3f, 127.3f, "RHB"};
        Object[] o10 = new Object[]{"Virat Kholi", "India", 52, 66.5f, 53.5f, 89.5f, 30.3f, 136.3f, "RHB"};
        Object[] o11 = new Object[]{"Rohit Sharma", "India", 32, 62.5f, 42.5f, 93.5f, 26.3f, 141.3f, "RHB"};
        for (int i = 1; i <= COUNT; i++) {
            inputHandler.send(o1);
    ...
    @Test
    public void testForDivideLongExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " long,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[( TestAverage / 5l > 9.0 )]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
        ...
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 63l, 51.5f, 50.5f, 82.7f, 16.3f, 112.2f, "RHB"};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 51l, 62.1f, 52.5f, 101.5f, 33.3f, 156.3f, "RHB"};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 57l, 47.5f, 52.5f, 86.5f, 26.3f, 127.3f, "RHB"};
        Object[] o10 = new Object[]{"Virat Kholi", "India", 52l, 66.5f, 53.5f, 89.5f, 30.3f, 136.3f, "RHB"};
        Object[] o11 = new Object[]{"Rohit Sharma", "India", 32l, 62.5f, 42.5f, 93.5f, 26.3f, 141.3f, "RHB"};
        for (int i = 1; i <= COUNT; i++) {
            inputHandler.send(o1);
    ...
    @Test
    public void testForAddFloatExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testForMultiplyFloatExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testForAddIntExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testForMultiplyIntExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " int,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(5 * TestAverage>225.0 )]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForAddLongExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testForMultiplyLongExpressionExecutorLeftSideConstantExperssionExecutorRightSideVariableExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
