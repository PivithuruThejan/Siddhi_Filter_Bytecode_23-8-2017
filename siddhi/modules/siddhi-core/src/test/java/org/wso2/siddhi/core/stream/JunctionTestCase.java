...
public class JunctionTestCase {
    ...
    @Test
    public void junctionToReceiverTest() throws InterruptedException, IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    @Test
    public void oneToOneTest() throws InterruptedException, IllegalAccessException, InstantiationException, InvocationTargetException {
        log.info("one to one");
        ...
        StreamCallback streamCallbackA = new StreamCallback() {
            @Override
            public void receive(Event[] streamEvents) throws IllegalAccessException, InstantiationException, InvocationTargetException {
...
//        Thread.sleep(100);
    ...
    @Test
    public void multiThreadedTest1() throws InterruptedException, IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    @Test
    public void multiThreadedTest2() throws InterruptedException, IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    @Test
    public void multiThreadedWithEventPoolTest() throws InterruptedException, IllegalAccessException, InstantiationException, InvocationTargetException {
