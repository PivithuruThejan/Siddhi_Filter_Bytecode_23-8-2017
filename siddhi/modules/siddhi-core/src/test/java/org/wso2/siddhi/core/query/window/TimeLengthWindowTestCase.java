...
public class TimeLengthWindowTestCase {
    ...
    */
    @Test
    public void timeLengthWindowTest1() throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
    ...
    */
    @Test
    public void timeLengthWindowTest2() throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
    ...
    */
    @Test
    public void timeLengthWindowTest3() throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
    ...
    */
    @Test
    public void timeLengthWindowTest4() throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
    ...
    */
    @Test
    public void timeLengthWindowTest6() throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
        log.info("Testing timeLength window with no of events greater than window length and time period greater than" +
                " window time");
    ...
    */
    @Test
    public void timeLengthWindowTest7() throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
        log.info("Testing timeLength window with no of events less than window length and time period less than " +
                "window time");
    ...
    */
    ...
    @Test
    public void timeLengthWindowTest10() throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
        log.info("Testing timeLength window with no of events greater than window length and time period less than " +
                "window time");
