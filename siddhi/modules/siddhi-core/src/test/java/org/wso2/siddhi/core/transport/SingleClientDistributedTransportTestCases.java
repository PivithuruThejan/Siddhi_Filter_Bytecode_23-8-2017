...
public class SingleClientDistributedTransportTestCases {
    ...
    @Test
    public void singleClientRoundRobin() throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
    ...
    @Test
    public void singleClientPartitioned() throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
        log.info("Test inMemorySink And EventMapping With SiddhiQL Dynamic Params");
    ...
    @Test
    public void singleClientBroadcast() throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
        log.info("Test inMemorySink And EventMapping With SiddhiQL Dynamic Params");
