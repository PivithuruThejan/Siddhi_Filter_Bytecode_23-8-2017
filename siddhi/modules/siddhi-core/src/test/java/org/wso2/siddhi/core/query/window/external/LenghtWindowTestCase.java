...
public class LenghtWindowTestCase {
    ...
    @Test
    public void testLengthWindow1() throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
    ...
    @Test
    public void testLengthWindow2() throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
    ...
    @Test
    public void testLengthWindow3() throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
        log.info("Testing length window with no of events greater than window size");
