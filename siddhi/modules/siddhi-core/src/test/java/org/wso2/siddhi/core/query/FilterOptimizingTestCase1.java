...
public class FilterOptimizingTestCase1 {
    ...
    @Test
    public void testANDWithBooleanVariableExpressionExecutor() throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        CHECK = 1;
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " float,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string, AggressiveBatting bool, Allrounder bool);";
        String query = "@info(name = 'query1') from players[(AggressiveBatting and Allrounder)]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
        ...
        siddhiAppRuntime.start();
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 33.0f, 62.5f, 32.5f, 80.5f, 16.3f, 116.3f, "LHB", false, false};
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", 47.6f, 65.3f, 42.1f, 83.4f, 26.3f, 136.3f, "RHB", true, true};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53.7f, 57.4f, 36.5f, 85.5f, 36.3f, 146.7f, "RHB", true, true};
        Object[] o4 = new Object[]{"Joe Root", "England", 55.8f, 52.5f, 52.7f, 88.3f, 24.9f, 128.3f, "RHB", true, true};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 41.2f, 72.5f, 43.6f, 90.7f, 22.3f, 133.8f, "LHB", true, true};
        Object[] o6 = new Object[]{"Kane Williamson", "New Zealand", 54.2f, 48.7f, 45.1f, 79.3f, 29.3f, 119.3f, "RHB", true, false};
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 63.3f, 51.5f, 50.5f, 82.7f, 16.3f, 112.2f, "RHB", true, true};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 51.9f, 62.1f, 52.5f, 101.5f, 33.3f, 156.3f, "RHB", true, true};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 47.8f, 47.5f, 52.5f, 86.5f, 26.3f, 127.3f, "RHB", null, true};
        Object[] o10 = new Object[]{"Virat Kholi", "India", 52.0f, 66.5f, 53.5f, 89.5f, 30.3f, 136.3f, "RHB", true, null};
        Object[] o11 = new Object[]{"Rohit Sharma", "India", 32.0f, 62.5f, 42.5f, 93.5f, 26.3f, 141.3f, "RHB", null, null};
        for (int i = 1; i <= COUNT; i++) {
            inputHandler.send(o1);
            inputHandler.send(o2);
            inputHandler.send(o3);
    ...
    @Test
    public void testORWithBooleanVariableExpressionExecutor() throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        CHECK = 1;
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " float,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string, AggressiveBatting bool, Allrounder bool);";
        String query = "@info(name = 'query1') from players[(AggressiveBatting or Allrounder)]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
        ...
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 63.3f, 51.5f, 50.5f, 82.7f, 16.3f, 112.2f, "RHB", true, true};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 51.9f, 62.1f, 52.5f, 101.5f, 33.3f, 156.3f, "RHB", true, true};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 47.8f, 47.5f, 52.5f, 86.5f, 26.3f, 127.3f, "RHB", null, null};
        Object[] o10 = new Object[]{"Virat Kholi", "India", 52.0f, 66.5f, 53.5f, 89.5f, 30.3f, 136.3f, "RHB", true, null};
        Object[] o11 = new Object[]{"Rohit Sharma", "India", 32.0f, 62.5f, 42.5f, 93.5f, 26.3f, 141.3f, "RHB", null, true};
        for (int i = 1; i <= COUNT; i++) {
            inputHandler.send(o1);
            inputHandler.send(o2);
            inputHandler.send(o3);
    ...
    @Test
    public void testNOTWithBooleanVariableExpressionExecutor() throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        CHECK = 1;
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " float,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string, AggressiveBatting bool, Allrounder bool);";
        String query = "@info(name = 'query1') from players[not(AggressiveBatting)]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testIsNullConditionExecutor() throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        CHECK = 1;
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " float,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[TestAverage is null and ODIAverage >= 42.1f]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
        ...
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 33.0f, 62.5f, 32.5f, 80.5f, 16.3f, 116.3f, "LHB"};
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", null, 65.3f, 42.1f, 83.4f, 26.3f, 136.3f, "RHB"};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53.7f, 57.4f, 36.5f, 85.5f, 36.3f, 146.7f, "RHB"};
        Object[] o4 = new Object[]{"Joe Root", "England", 55.8f, 52.5f, 52.7f, 88.3f, 24.9f, 128.3f, "RHB"};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 41.2f, 72.5f, 43.6f, 90.7f, 22.3f, 133.8f, "LHB"};
        Object[] o6 = new Object[]{"Kane Williamson", "New Zealand", 54.2f, 48.7f, 45.1f, 79.3f, 29.3f, 119.3f, "RHB"};
    ...
    @Test
    public void testIsNullStreamConditionExecutor() throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        CHECK = 1;
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " float,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from e1=players[not(e1 is null)]" +
                " select playerName, BattingStyle insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForAddDoubleExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                ...
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage + 5.0 + TestAverage>50.0 + TestAverage)]" +
                " select playerName, BattingStyle, TestAverage + 5.0 as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            @Override
        ...
        siddhiAppRuntime.start();
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", null, 62.5f, 32.5f, 80.5f, 16.3f, 116.3f, "LHB"};
    ...
    @Test
    public void testForSubtractDoubleExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " double,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage - 5.0 >40.0 )]" +
                " select playerName, BattingStyle, TestAverage + 5.0 as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForSubtractFloatExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " float,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage - 5f >40.0 )]" +
                " select playerName, BattingStyle, TestAverage + 5.0 as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForSubtractIntegerExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                ...
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage - 5 >40.0 )]" +
                " select playerName, BattingStyle, TestAverage + 5.0 as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForSubtractLongExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                ...
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage - 5l >40.0 )]" +
                " select playerName, BattingStyle, TestAverage + 5.0 as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForMultiplyDoubleExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " double,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage * 5f * TestAverage>225.0 * TestAverage)]" +
                " select playerName, BattingStyle, TestAverage * 5.0 as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForDivideDoubleExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " double,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage / 5f / TestAverage>9.0/ TestAverage)]" +
    ...
    @Test
    public void testForModeDoubleExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " double,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage % 5.0 >3)]" +
                " select playerName, BattingStyle, TestAverage % 5.0f as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForModFloatExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " float,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage % 5f>3)]" +
                " select playerName, BattingStyle, TestAverage % 5.0f as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForModIntgerExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " int,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage % 5 >2)]" +
                " select playerName, BattingStyle, TestAverage % 5.0f as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForModLongExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testForModIntegerExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testForDivideFloatExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " float,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage / 5f / TestAverage>9f / TestAverage)]" +
                " select playerName, BattingStyle, TestAverage / 5.0f as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForDivideIntegerExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " int,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage / 5f / TestAverage>9 / TestAverage)]" +
                " select playerName, BattingStyle, TestAverage / 5.0f as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
        ...
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53, 57.4f, 36.5f, 85.5f, 36.3f, 146.7f, "RHB"};
        Object[] o4 = new Object[]{"Joe Root", "England", 55, 52.5f, 52.7f, 88.3f, 24.9f, 128.3f, "RHB"};
        Object[] o5 = new Object[]{"Ben Stokes", "England", null, 72.5f, 43.6f, 90.7f, 22.3f, 133.8f, "LHB"};
        Object[] o6 = new Object[]{"Kane Williamson", "New Zealand", 54, 48.7f, 45.1f, 79.3f, 29.3f, 119.3f, "RHB"};
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 63, 51.5f, 50.5f, 82.7f, 16.3f, 112.2f, "RHB"};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 51, 62.1f, 52.5f, 101.5f, 33.3f, 156.3f, "RHB"};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 47, 47.5f, 52.5f, 86.5f, 26.3f, 127.3f, "RHB"};
    ...
    @Test
    public void testForDivideLongExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " long,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage / 5f / TestAverage>9l / TestAverage)]" +
                " select playerName, BattingStyle, TestAverage / 5.0f as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForAddFloatExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " float,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage + 5.0 + TestAverage>50f + TestAverage)]" +
                " select playerName, BattingStyle, TestAverage + 5.0f as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForMultiplyFloatExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " float,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage * 5.0 * TestAverage>225f * TestAverage)]" +
                " select playerName, BattingStyle, TestAverage * 5.0f as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForAddIntExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " int,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage + 5l + TestAverage>50 + TestAverage)]" +
                " select playerName, BattingStyle, TestAverage + 5.0f as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForMultiplyIntExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " int,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage * 5 * TestAverage>225 * TestAverage)]" +
                " select playerName, BattingStyle, TestAverage * 5.0f as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForAddLongExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " long,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage + 5l + TestAverage>50l + TestAverage)]" +
                " select playerName, BattingStyle, TestAverage + 5.0f as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForMultiplyLongExpressionExecutorLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor
            () throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        String definition = "@config(async = 'true') define stream players(playerName string,country string,TestAverage" +
                " long,TestStrikeRate float,ODIAverage float,ODIStrikeRate float,T20Average float,T20StrikeRate float," +
                "BattingStyle string);";
        String query = "@info(name = 'query1') from players[(TestAverage * 5l * TestAverage>225l * TestAverage)]" +
                " select playerName, BattingStyle, TestAverage * 5.0f as newAverage, TestAverage  insert into sqaud;";
        SiddhiManager siddhiManager = new SiddhiManager();
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(definition + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
    ...
    @Test
    public void testForGreaterThanEqualOperatorIntegerLongLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    public void testLessthanOperatorFloatIntegerLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
        ...
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53.7f, 57.4f, 36.5f, 85.5f, 36.3f, 146.7f, "RHB"};
        Object[] o4 = new Object[]{"Joe Root", "England", 55.8f, 52.5f, 52.7f, 88.3f, 24.9f, 128.3f, "RHB"};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 44.0f, 72.5f, 43.6f, 90.7f, 22.3f, 133.8f, "LHB"};
        Object[] o6 = new Object[]{"Kane Williamson", "New Zealand", 54.2f, 48.7f, 45.1f, 79.3f, 29.3f, 119.3f, "RHB"};
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 63.3f, 51.5f, 50.5f, 82.7f, 16.3f, 112.2f, "RHB"};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 51.9f, 62.1f, 52.5f, 101.5f, 33.3f, 156.3f, "RHB"};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 47.8f, 47.5f, 52.5f, 86.5f, 26.3f, 127.3f, "RHB"};
    ...
    @Test
    public void testLessThanEqualOperatorFloatIntegerLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testNotEqualDoubleDoubleLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        siddhiAppRuntime.start();
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 31.0, 33.0, 32.5f, 80.5f, 16.3f, 116.3f, "LHB"};
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", null, 47.6, 42.1f, 83.4f, 26.3f, 136.3f, "RHB",};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 33.0, 53.7, 36.5f, 85.5f, 36.3f, 146.7f, "RHB",};
        Object[] o4 = new Object[]{"Joe Root", "England", 33.0, 55.8, 52.7f, 88.3f, 24.9f, 128.3f, "RHB"};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 33.0, 41.2, 43.6f, 90.7f, 22.3f, 133.8f, "LHB"};
        Object[] o6 = new Object[]{"Kane Williamson", "New Zealand", 33.0, 54.2, 45.1f, 79.3f, 29.3f, 119.3f, "RHB"};
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 33.0, 63.3, 50.5f, 82.7f, 16.3f, 112.2f, "RHB"};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 33.0, 51.9, 52.5f, 101.5f, 33.3f, 156.3f, "RHB"};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 33.0, 47.8, 52.5f, 86.5f, 26.3f, 127.3f, "RHB"};
        Object[] o10 = new Object[]{"Virat Kholi", "India", 33.0, 52.0, 53.5f, 89.5f, 30.3f, 136.3f, "RHB"};
        Object[] o11 = new Object[]{"Rohit Sharma", "India", 33.0, 32.0, 42.5f, 93.5f, 26.3f, 141.3f, "RHB"};
        for (int i = 1; i <= COUNT; i++) {
            inputHandler.send(o1);
            inputHandler.send(o2);
            inputHandler.send(o3);
    ...
    @Test
    public void testNotEqualFloatDoubleLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        siddhiAppRuntime.start();
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 33.0, 33.0, 32.6f, 80.5f, 16.3f, 116.3f, "LHB"};
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", 47.6, 65.3, null, 83.4f, 26.3f, 136.3f, "RHB",};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53.7, 57.4, 32.5f, 85.5f, 36.3f, 146.7f, "RHB",};
        Object[] o4 = new Object[]{"Joe Root", "England", 55.8, 52.5, 32.5f, 88.3f, 24.9f, 128.3f, "RHB"};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 41.2, 72.5, 32.5f, 90.7f, 22.3f, 133.8f, "LHB"};
        Object[] o6 = new Object[]{"Kane Williamson", "New Zealand", 54.2, 48.7, 32.5f, 79.3f, 29.3f, 119.3f, "RHB"};
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 63.3, 51.5, 32.5f, 82.7f, 16.3f, 112.2f, "RHB"};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 51.9, 62.1, 32.5f, 101.5f, 33.3f, 156.3f, "RHB"};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 47.8, 47.5, 32.5f, 86.5f, 26.3f, 127.3f, "RHB"};
        Object[] o10 = new Object[]{"Virat Kholi", "India", 52.0, 66.5, 32.5f, 89.5f, 30.3f, 136.3f, "RHB"};
        Object[] o11 = new Object[]{"Rohit Sharma", "India", 32.0, 62.5, 32.5f, 93.5f, 26.3f, 141.3f, "RHB"};
        for (int i = 1; i <= COUNT; i++) {
            inputHandler.send(o1);
            inputHandler.send(o2);
            inputHandler.send(o3);
    ...
    @Test
    public void testNotEqualIntegerFloatLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", 47.6, 65.3, null, 83.4f, 26.3f, 136.3f, "RHB",};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53.7, 57.4, 32, 85.5f, 36.3f, 146.7f, "RHB",};
        Object[] o4 = new Object[]{"Joe Root", "England", 55.8, 52.5, 32, 88.3f, 24.9f, 128.3f, "RHB"};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 41.2, 72.5, 32, 90.7f, 22.3f, 133.8f, "LHB"};
        Object[] o6 = new Object[]{"Kane Williamson", "New Zealand", 54.2, 48.7, 32, 79.3f, 29.3f, 119.3f, "RHB"};
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 63.3, 51.5, 32, 82.7f, 16.3f, 112.2f, "RHB"};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 51.9, 62.1, 32, 101.5f, 33.3f, 156.3f, "RHB"};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 47.8, 47.5, 32, 86.5f, 26.3f, 127.3f, "RHB"};
        Object[] o10 = new Object[]{"Virat Kholi", "India", 52.0, 66.5, 32, 89.5f, 30.3f, 136.3f, "RHB"};
    ...
    @Test
    public void testNotEqualIntegerIntegerLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        siddhiAppRuntime.start();
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 33.0, 33.0, 31, 80.5f, 16.3f, 116.3f, "LHB"};
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", 47.6, 65.3, null, 83.4f, 26.3f, 136.3f, "RHB",};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53.7, 57.4, 32, 85.5f, 36.3f, 146.7f, "RHB",};
        Object[] o4 = new Object[]{"Joe Root", "England", 55.8, 52.5, 32, 88.3f, 24.9f, 128.3f, "RHB"};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 41.2, 72.5, 32, 90.7f, 22.3f, 133.8f, "LHB"};
    ...
    @Test
    public void testNotEqualIntegerLongLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testEqualIntegerDoubleLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testNotEqualIntegerDoubleLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testNotEqualLongDoubleLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", 47.6, 65.3, null, 83.4f, 26.3f, 136.3f, "RHB",};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53.7, 57.4, 32l, 85.5f, 36.3f, 146.7f, "RHB",};
        Object[] o4 = new Object[]{"Joe Root", "England", 55.8, 52.5, 32l, 88.3f, 24.9f, 128.3f, "RHB"};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 41.2, 72.5, 32l, 90.7f, 22.3f, 133.8f, "LHB"};
        Object[] o6 = new Object[]{"Kane Williamson", "New Zealand", 54.2, 48.7, 32l, 79.3f, 29.3f, 119.3f, "RHB"};
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 63.3, 51.5, 32l, 82.7f, 16.3f, 112.2f, "RHB"};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 51.9, 62.1, 32l, 101.5f, 33.3f, 156.3f, "RHB"};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 47.8, 47.5, 32l, 86.5f, 26.3f, 127.3f, "RHB"};
        Object[] o10 = new Object[]{"Virat Kholi", "India", 52.0, 66.5, 32l, 89.5f, 30.3f, 136.3f, "RHB"};
        Object[] o11 = new Object[]{"Rohit Sharma", "India", 32.0, 62.5, 32l, 93.5f, 26.3f, 141.3f, "RHB"};
        for (int i = 1; i <= COUNT; i++) {
            inputHandler.send(o1);
            inputHandler.send(o2);
            inputHandler.send(o3);
    ...
    @Test
    public void testNotEqualLongFloatLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testNotEqualLongIntegerLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        siddhiAppRuntime.start();
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 33.0, 33.0, 31l, 80.5f, 16.3f, 116.3f, "LHB"};
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", 47.6, 65.3, null, 83.4f, 26.3f, 136.3f, "RHB",};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53.7, 57.4, 32l, 85.5f, 36.3f, 146.7f, "RHB",};
        Object[] o4 = new Object[]{"Joe Root", "England", 55.8, 52.5, 32l, 88.3f, 24.9f, 128.3f, "RHB"};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 41.2, 72.5, 32l, 90.7f, 22.3f, 133.8f, "LHB"};
    ...
    @Test
    public void testNotEqualLongLongLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testNotEqualFloatFloatLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        siddhiAppRuntime.start();
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 33.0, 33.0, 32.4f, 80.5f, 16.3f, 116.3f, "LHB"};
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", 47.6, 65.3, null, 83.4f, 26.3f, 136.3f, "RHB",};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53.7, 57.4, 32.5f, 85.5f, 36.3f, 146.7f, "RHB",};
        Object[] o4 = new Object[]{"Joe Root", "England", 55.8, 52.5, 32.5f, 88.3f, 24.9f, 128.3f, "RHB"};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 41.2, 72.5, 32.5f, 90.7f, 22.3f, 133.8f, "LHB"};
    ...
    @Test
    public void testNotEqualFloatIntLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        siddhiAppRuntime.start();
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 33.0, 33.0, 32.1f, 80.5f, 16.3f, 116.3f, "LHB"};
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", 47.6, 65.3, null, 83.4f, 26.3f, 136.3f, "RHB",};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53.7, 57.4, 32.0f, 85.5f, 36.3f, 146.7f, "RHB",};
        Object[] o4 = new Object[]{"Joe Root", "England", 55.8, 52.5, 32.0f, 88.3f, 24.9f, 128.3f, "RHB"};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 41.2, 72.5, 32.0f, 90.7f, 22.3f, 133.8f, "LHB"};
        Object[] o6 = new Object[]{"Kane Williamson", "New Zealand", 54.2, 48.7, 32.0f, 79.3f, 29.3f, 119.3f, "RHB"};
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 63.3, 51.5, 32.0f, 82.7f, 16.3f, 112.2f, "RHB"};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 51.9, 62.1, 32.0f, 101.5f, 33.3f, 156.3f, "RHB"};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 47.8, 47.5, 32.0f, 86.5f, 26.3f, 127.3f, "RHB"};
        Object[] o10 = new Object[]{"Virat Kholi", "India", 52.0, 66.5, 32.0f, 89.5f, 30.3f, 136.3f, "RHB"};
        Object[] o11 = new Object[]{"Rohit Sharma", "India", 32.0, 62.5, 32.0f, 93.5f, 26.3f, 141.3f, "RHB"};
        for (int i = 1; i <= COUNT; i++) {
            inputHandler.send(o1);
            inputHandler.send(o2);
            inputHandler.send(o3);
    ...
    @Test
    public void testNotEqualDoubleFloatLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        siddhiAppRuntime.start();
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 13.0, 33.0, 32.5f, 80.5f, 16.3f, 116.3f, "LHB"};
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", null, 65.3, 42.1f, 83.4f, 26.3f, 136.3f, "RHB",};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 33.0, 57.4, 36.5f, 85.5f, 36.3f, 146.7f, "RHB",};
        Object[] o4 = new Object[]{"Joe Root", "England", 33.0, 52.5, 52.7f, 88.3f, 24.9f, 128.3f, "RHB"};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 33.0, 72.5, 43.6f, 90.7f, 22.3f, 133.8f, "LHB"};
        Object[] o6 = new Object[]{"Kane Williamson", "New Zealand", 33.0, 48.7, 45.1f, 79.3f, 29.3f, 119.3f, "RHB"};
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 33.0, 51.5, 50.5f, 82.7f, 16.3f, 112.2f, "RHB"};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 33.0, 62.1, 52.5f, 101.5f, 33.3f, 156.3f, "RHB"};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 33.0, 47.5, 52.5f, 86.5f, 26.3f, 127.3f, "RHB"};
        Object[] o10 = new Object[]{"Virat Kholi", "India", 33.0, 66.5, 53.5f, 89.5f, 30.3f, 136.3f, "RHB"};
        Object[] o11 = new Object[]{"Rohit Sharma", "India", 33.0, 62.5, 42.5f, 93.5f, 26.3f, 141.3f, "RHB"};
        for (int i = 1; i <= COUNT; i++) {
            inputHandler.send(o1);
            inputHandler.send(o2);
            inputHandler.send(o3);
    ...
    @Test
    public void testNotEqualDoubleIntegerLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
    ...
    @Test
    public void testNotEqualDoubleLongLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        siddhiAppRuntime.start();
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 33.1, 33.0, 32.5f, 80.5f, 16.3f, 116.3f, "LHB"};
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", null, 65.3, 42.1f, 83.4f, 26.3f, 136.3f, "RHB",};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 33.0, 57.4, 36.5f, 85.5f, 36.3f, 146.7f, "RHB",};
        Object[] o4 = new Object[]{"Joe Root", "England", 33.0, 52.5, 52.7f, 88.3f, 24.9f, 128.3f, "RHB"};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 33.0, 72.5, 43.6f, 90.7f, 22.3f, 133.8f, "LHB"};
    ...
    @Test
    public void testNotEqualFloatLongLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        siddhiAppRuntime.start();
        long start = System.currentTimeMillis();
        Object[] o1 = new Object[]{"Upul Tharanga", "Sri Lanka", 33.0, 33.0, 32.5f, 80.1f, 16.3f, 116.3f, "LHB"};
        Object[] o2 = new Object[]{"Anjelo Mathews", "Sri Lanka", 47.6, 65.3, 42.1f, null, 26.3f, 136.3f, "RHB",};
        Object[] o3 = new Object[]{"Asela Gunaratne", "Sri Lanka", 53.7, 57.4, 36.5f, 80f, 36.3f, 146.7f, "RHB",};
        Object[] o4 = new Object[]{"Joe Root", "England", 55.8, 52.5, 52.7f, 80f, 24.9f, 128.3f, "RHB"};
        Object[] o5 = new Object[]{"Ben Stokes", "England", 41.2, 72.5, 43.6f, 80f, 22.3f, 133.8f, "LHB"};
        Object[] o6 = new Object[]{"Kane Williamson", "New Zealand", 54.2, 48.7, 45.1f, 80f, 29.3f, 119.3f, "RHB"};
        Object[] o7 = new Object[]{"Steve Smith", "Australia", 63.3, 51.5, 50.5f, 80f, 16.3f, 112.2f, "RHB"};
        Object[] o8 = new Object[]{"AB de Villiers", "South Africa", 51.9, 62.1, 52.5f, 80f, 33.3f, 156.3f, "RHB"};
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 47.8, 47.5, 52.5f, 80f, 26.3f, 127.3f, "RHB"};
        Object[] o10 = new Object[]{"Virat Kholi", "India", 52.0, 66.5, 53.5f, 80f, 30.3f, 136.3f, "RHB"};
        Object[] o11 = new Object[]{"Rohit Sharma", "India", 32.0, 62.5, 42.5f, 80f, 26.3f, 141.3f, "RHB"};
        for (int i = 1; i <= COUNT; i++) {
            inputHandler.send(o1);
            inputHandler.send(o2);
            inputHandler.send(o3);
    ...
    @Test
    public void testNotEqualStringStringLeftSideVariableExperssionExecutorRightSideConstantExpressionExecutor()
            throws InterruptedException, IllegalAccessException, InvocationTargetException,
            InstantiationException, IOException {
        ...
        Object[] o9 = new Object[]{"Hashim Amla", "South Africa", 47.8, 47.5, 52.5f, 86.5f, 26.3f, 127.3f, "RHB"};
        Object[] o10 = new Object[]{"Virat Kholi", "India", 52.0, 66.5, 53.5f, 89.5f, 30.3f, 136.3f, "RHB"};
        Object[] o11 = new Object[]{null, "India", 32.0, 62.5, 42.5f, 93.5f, 26.3f, 141.3f, "RHB"};
        for (int i = 1; i <= COUNT; i++) {
            inputHandler.send(o1);
            inputHandler.send(o2);
            inputHandler.send(o3);
