...
public class TestSiddhiLatency {
    ...
    public static void init() throws IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    public static boolean isThrottled(Object[] throttleRequest) throws IllegalAccessException, InvocationTargetException, InstantiationException {
