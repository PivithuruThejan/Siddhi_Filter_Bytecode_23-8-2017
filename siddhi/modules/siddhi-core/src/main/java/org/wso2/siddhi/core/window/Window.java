...
public class Window implements FindableProcessor, Snapshotable {
     ...
     */
    public void add(ComplexEventChunk complexEventChunk) throws IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
        try {
     ...
     */
    @Override
    public StreamEvent find(StateEvent matchingEvent, CompiledCondition compiledCondition) throws IllegalAccessException, InvocationTargetException, InstantiationException {
     ...
     */
    @Override
    public void restoreState(Map<String, Object> state) throws IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    private class StreamPublishProcessor implements Processor {
        ...
        public void process(ComplexEventChunk complexEventChunk) throws IllegalAccessException, InstantiationException, InvocationTargetException {
