...
public class PassThroughSourceMapper extends SourceMapper {
    ...
    @Override
    protected void mapAndProcess(Object eventObject, InputEventHandler inputEventHandler) throws InterruptedException, IllegalAccessException, InstantiationException, InvocationTargetException {
        if (eventObject != null) {
