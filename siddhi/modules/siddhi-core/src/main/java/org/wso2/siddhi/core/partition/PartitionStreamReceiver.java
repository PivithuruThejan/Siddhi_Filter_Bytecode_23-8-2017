...
public class PartitionStreamReceiver implements StreamJunction.Receiver {
    ...
    @Override
    public void receive(ComplexEvent complexEvent) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    @Override
    public void receive(Event event) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        StreamEvent borrowedEvent = eventPool.borrowEvent();
    ...
    @Override
    public void receive(long timestamp, Object[] data) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        StreamEvent borrowedEvent = eventPool.borrowEvent();
    ...
    @Override
    public void receive(Event[] events) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        if (partitionExecutors.size() == 0) {
    ...
    private void send(String key, ComplexEvent event) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        if (key != null) {
    ...
    private void send(ComplexEvent event) throws IllegalAccessException, InvocationTargetException, InstantiationException {
