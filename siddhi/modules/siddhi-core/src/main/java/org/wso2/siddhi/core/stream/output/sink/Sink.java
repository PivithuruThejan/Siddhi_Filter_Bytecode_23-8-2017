...
public abstract class Sink implements SinkListener, Snapshotable {
    ...
    @Override
    public final void publish(Object payload) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        if (isConnected.get()) {
            try {
    ...
    public abstract void publish(Object payload, DynamicOptions transportOptions)
            throws ConnectionUnavailableException, IllegalAccessException, InstantiationException, InvocationTargetException;
