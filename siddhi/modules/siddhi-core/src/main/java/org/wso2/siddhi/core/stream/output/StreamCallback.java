...
public abstract class StreamCallback implements StreamJunction.Receiver {
    ...
    @Override
    public void receive(Event event, boolean endOfBatch) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    public void receiveEvents(Event[] events) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        try {
            receive(events);
    ...
    public abstract void receive(Event[] events) throws IllegalAccessException, InstantiationException, InvocationTargetException;
