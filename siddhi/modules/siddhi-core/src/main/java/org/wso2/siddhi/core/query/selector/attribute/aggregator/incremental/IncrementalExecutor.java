...
public class IncrementalExecutor implements Executor {
    ...
    @Override
    public void execute(ComplexEventChunk streamEventChunk) throws IllegalAccessException, InstantiationException, InvocationTargetException {
...
//            LOG.info(duration + "..." + streamEvent.getType());
    ...
    private void sendTimerEvent(StreamEvent streamEvent, long timestamp) throws IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    private long getTimestamp(StreamEvent streamEvent) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        long timestamp;
        if (streamEvent.getType() == ComplexEvent.Type.CURRENT) {
    ...
    private void processAggregates(StreamEvent streamEvent) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        synchronized (this) {
            if (isGroupBy) {
                try {
    ...
    private void process(StreamEvent streamEvent, BaseIncrementalValueStore baseIncrementalValueStore) throws IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    private void dispatchAggregateEvents(long startTimeOfNewAggregates, long currentTimeStamp) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    private void dispatchEvent(long startTimeOfNewAggregates, BaseIncrementalValueStore aBaseIncrementalValueStore) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    private void dispatchEvents(Map<String, BaseIncrementalValueStore> baseIncrementalValueGroupByStore) throws IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    private void cleanBaseIncrementalValueStore(long startTimeOfNewAggregates,
                                                BaseIncrementalValueStore baseIncrementalValueStore) throws IllegalAccessException, InvocationTargetException, InstantiationException {
