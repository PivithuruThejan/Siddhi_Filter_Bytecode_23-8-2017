...
public interface FindableProcessor {
     ...
     */
    StreamEvent find(StateEvent matchingEvent, CompiledCondition compiledCondition) throws IllegalAccessException, InstantiationException, InvocationTargetException;
