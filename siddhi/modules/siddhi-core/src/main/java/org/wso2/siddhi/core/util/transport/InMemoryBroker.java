...
public class InMemoryBroker {
    ...
    public static void publish(String topic, Object message) throws IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    interface Broker {
        ...
        void broadcast(String topic, Object msg) throws IllegalAccessException, InvocationTargetException, InstantiationException;
    }
    ...
    public interface Subscriber {
        void onMessage(Object msg) throws IllegalAccessException, InstantiationException, InvocationTargetException;
    ...
    private static class MessageBroker implements Broker {
        ...
        @Override
        public void broadcast(String topic, Object msg) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        public void publish(String topic, Object msg) throws IllegalAccessException, InstantiationException, InvocationTargetException {
            broadcast(topic, msg);
        }
