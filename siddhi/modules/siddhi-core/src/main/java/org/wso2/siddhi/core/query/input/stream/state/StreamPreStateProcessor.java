...
public class StreamPreStateProcessor implements PreStateProcessor, Snapshotable {
    ...
    protected void process(StateEvent stateEvent) throws IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
    ...
    @Override
    public ComplexEventChunk<StateEvent> processAndReturn(ComplexEventChunk complexEventChunk) throws IllegalAccessException, InstantiationException, InvocationTargetException, IOException {
