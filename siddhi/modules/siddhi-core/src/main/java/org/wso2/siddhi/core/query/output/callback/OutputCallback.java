...
public abstract class OutputCallback {
    ...
    public abstract void send(ComplexEventChunk complexEventChunk) throws IllegalAccessException, InstantiationException, InvocationTargetException, IOException;
