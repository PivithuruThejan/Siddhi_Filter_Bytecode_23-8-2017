...
public class EventChunkOperator implements Operator {
    ...
    @Override
    public StreamEvent find(StateEvent matchingEvent, Object storeEvents, StreamEventCloner storeEventCloner) throws IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    @Override
    public boolean contains(StateEvent matchingEvent, Object storeEvents) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        ComplexEventChunk<StreamEvent> storeEventChunk = (ComplexEventChunk<StreamEvent>) storeEvents;
        try {
            storeEventChunk.reset();
            while (storeEventChunk.hasNext()) {
    ...
    @Override
    public void delete(ComplexEventChunk<StateEvent> deletingEventChunk, Object storeEvents) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        ComplexEventChunk<StreamEvent> storeEventChunk = (ComplexEventChunk<StreamEvent>) storeEvents;
    ...
    public void update(ComplexEventChunk<StateEvent> updatingEventChunk, Object storeEvents, UpdateAttributeMapper[]
            updateAttributeMappers) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        ComplexEventChunk<StreamEvent> storeEventChunk = (ComplexEventChunk<StreamEvent>) storeEvents;
