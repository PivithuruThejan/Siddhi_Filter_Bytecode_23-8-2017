...
public class MultiProcessStreamReceiver extends ProcessStreamReceiver {
    ...
    private void process(int eventSequence, StreamEvent borrowedEvent) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        if (lockWrapper != null) {
            lockWrapper.lock();
        }
        try {
    ...
    @Override
    public void receive(ComplexEvent complexEvent) throws IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    protected void processAndClear(int processIndex, StreamEvent streamEvent) throws IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
