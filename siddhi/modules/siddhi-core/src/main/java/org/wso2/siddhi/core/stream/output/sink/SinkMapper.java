...
public abstract class SinkMapper {
     ...
     */
    final void mapAndSend(Event[] events) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        try {
     ...
     */
    final void mapAndSend(Event event) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        try {
    ...
    public abstract void mapAndSend(Event[] events, OptionHolder optionHolder, TemplateBuilder payloadTemplateBuilder,
                                    SinkListener sinkListener) throws IllegalAccessException, InstantiationException, InvocationTargetException;
