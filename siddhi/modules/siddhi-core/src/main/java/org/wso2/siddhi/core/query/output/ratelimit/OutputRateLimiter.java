...
public abstract class OutputRateLimiter implements EternalReferencedHolder, Snapshotable {
    ...
    public abstract void process(ComplexEventChunk complexEventChunk) throws IllegalAccessException, InvocationTargetException, InstantiationException, IOException;
