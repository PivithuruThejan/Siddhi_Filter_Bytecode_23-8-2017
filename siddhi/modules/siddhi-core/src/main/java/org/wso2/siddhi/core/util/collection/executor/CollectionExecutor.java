...
public interface CollectionExecutor {
     ...
     */
    Collection<StreamEvent> findEvents(StateEvent matchingEvent, IndexedEventHolder indexedEventHolder) throws IllegalAccessException, InstantiationException, InvocationTargetException;
     ...
     */
    boolean contains(StateEvent matchingEvent, IndexedEventHolder indexedEventHolder) throws IllegalAccessException, InvocationTargetException, InstantiationException;
     ...
     * @param indexedEventHolder indexed EventHolder containing data
     */
    void delete(StateEvent deletingEvent, IndexedEventHolder indexedEventHolder) throws IllegalAccessException, InvocationTargetException, InstantiationException;
