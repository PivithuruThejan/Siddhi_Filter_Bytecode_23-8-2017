...
public abstract class SourceMapper implements SourceEventListener {
    ...
    public final void onEvent(Object eventObject, String[] transportProperties) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        try {
            if (eventObject != null) {
