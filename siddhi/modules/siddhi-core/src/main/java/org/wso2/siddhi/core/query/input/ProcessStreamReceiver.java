...
public class ProcessStreamReceiver implements StreamJunction.Receiver {
    ...
    private void process(ComplexEventChunk<StreamEvent> streamEventChunk) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        if (lockWrapper != null) {
            lockWrapper.lock();
        }
        try {
    ...
    @Override
    public void receive(ComplexEvent complexEvents) throws IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    @Override
    public void receive(Event event) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        if (event != null) {
    ...
    @Override
    public void receive(Event[] events) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        StreamEvent firstEvent = streamEventPool.borrowEvent();
    ...
    @Override
    public void receive(Event event, boolean endOfBatch) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        StreamEvent borrowedEvent = streamEventPool.borrowEvent();
        streamEventConverter.convertEvent(event, borrowedEvent);
    ...
    @Override
    public void receive(long timestamp, Object[] data) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        StreamEvent borrowedEvent = streamEventPool.borrowEvent();
    ...
    protected void processAndClear(ComplexEventChunk<StreamEvent> streamEventChunk) throws IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
