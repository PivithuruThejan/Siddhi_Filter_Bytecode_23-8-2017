...
public void init(TableDefinition tableDefinition, StreamEventPool storeEventPool,
    ...
    @Override
    public void delete(ComplexEventChunk<StateEvent> deletingEventChunk, CompiledCondition compiledCondition) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        try {
            readWriteLock.writeLock().lock();
    ...
    public void update(ComplexEventChunk<StateEvent> updatingEventChunk, CompiledCondition compiledCondition,
                       UpdateAttributeMapper[] updateAttributeMappers) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        try {
            readWriteLock.writeLock().lock();
    ...
    public void updateOrAdd(ComplexEventChunk<StateEvent> updateOrAddingEventChunk, CompiledCondition compiledCondition,
                            ...
                            AddingStreamEventExtractor addingStreamEventExtractor) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        try {
            readWriteLock.writeLock().lock();
    ...
    @Override
    public boolean contains(StateEvent matchingEvent, CompiledCondition compiledCondition) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        try {
    ...
    @Override
    public StreamEvent find(CompiledCondition compiledCondition, StateEvent matchingEvent) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        try {
            readWriteLock.readLock().lock();
