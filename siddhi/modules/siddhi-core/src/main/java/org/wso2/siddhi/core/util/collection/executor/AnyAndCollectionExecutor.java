...
public class AnyAndCollectionExecutor implements CollectionExecutor {
    ...
    public StreamEvent find(StateEvent matchingEvent, IndexedEventHolder indexedEventHolder, StreamEventCloner
            storeEventCloner) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    public Collection<StreamEvent> findEvents(StateEvent matchingEvent, IndexedEventHolder indexedEventHolder) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    @Override
    public boolean contains(StateEvent matchingEvent, IndexedEventHolder indexedEventHolder) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        Collection<StreamEvent> resultEventSet = findEvents(matchingEvent, indexedEventHolder);
        if (resultEventSet != null) {
    ...
    @Override
    public void delete(StateEvent deletingEvent, IndexedEventHolder indexedEventHolder) throws IllegalAccessException, InstantiationException, InvocationTargetException {
