...
public class NonCollectionExecutor implements CollectionExecutor {
    ...
    public StreamEvent find(StateEvent matchingEvent, IndexedEventHolder indexedEventHolder, StreamEventCloner
            storeEventCloner) throws IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    public Collection<StreamEvent> findEvents(StateEvent matchingEvent, IndexedEventHolder indexedEventHolder) throws IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    @Override
    public boolean contains(StateEvent matchingEvent, IndexedEventHolder indexedEventHolder) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        return (Boolean) expressionExecutor.execute(matchingEvent);
    }

    @Override
    public void delete(StateEvent deletingEvent, IndexedEventHolder indexedEventHolder) throws IllegalAccessException, InvocationTargetException, InstantiationException {
