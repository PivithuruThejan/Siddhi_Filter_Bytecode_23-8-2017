...
public abstract class SnapshotOutputRateLimiter implements Schedulable {
    ...
    public abstract void process(ComplexEventChunk complexEventChunk) throws IllegalAccessException, InstantiationException, InvocationTargetException, IOException;
    ...
    protected void sendToCallBacks(ComplexEventChunk complexEventChunk) throws IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
