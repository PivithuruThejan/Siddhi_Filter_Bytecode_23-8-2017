...
public class StreamJunction {
    ...
    public void sendEvent(ComplexEvent complexEvent) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        if (isTraceEnabled) {
    ...
    public void sendEvent(Event event) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        if (throughputTracker != null) {
            throughputTracker.eventIn();
        }
        if (isTraceEnabled) {
    ...
    private void sendEvent(Event[] events) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        if (throughputTracker != null) {
    ...
    private void sendEvent(List<Event> events) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        if (isTraceEnabled) {
            log.trace("Event is received by streamJunction " + this);
        }
        if (disruptor != null) {
    ...
    private void sendData(long timeStamp, Object[] data) throws IllegalAccessException, InstantiationException, InvocationTargetException, IOException {
    ...
    public interface Receiver {
        ...
        void receive(ComplexEvent complexEvent) throws IllegalAccessException, InvocationTargetException, InstantiationException;

        void receive(Event event) throws IllegalAccessException, InvocationTargetException, InstantiationException;

        void receive(Event event, boolean endOfBatch) throws IllegalAccessException, InvocationTargetException, InstantiationException;

        void receive(long timeStamp, Object[] data) throws IllegalAccessException, InvocationTargetException, InstantiationException;

        void receive(Event[] events) throws IllegalAccessException, InvocationTargetException, InstantiationException;
    }
    ...
    public class StreamHandler implements EventHandler<Event> {
        ...
        public void onEvent(Event event, long sequence, boolean endOfBatch) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    public class Publisher implements InputProcessor {
        ...
        public void send(ComplexEvent complexEvent) throws IllegalAccessException, InvocationTargetException, InstantiationException {
            streamJunction.sendEvent(complexEvent);
        }

        @Override
        public void send(Event event, int streamIndex) throws IllegalAccessException, InvocationTargetException, InstantiationException {
            streamJunction.sendEvent(event);
        }

        @Override
        public void send(Event[] events, int streamIndex) throws IllegalAccessException, InvocationTargetException, InstantiationException {
            streamJunction.sendEvent(events);
        }

        @Override
        public void send(List<Event> events, int streamIndex) throws IllegalAccessException, InvocationTargetException, InstantiationException {
            streamJunction.sendEvent(events);
        }

        @Override
        public void send(long timeStamp, Object[] data, int streamIndex) throws IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
