...
public class InputEventHandler {
    ...
    public void sendEvent(Event event) throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException {
        try {
    ...
    public void sendEvents(Event[] events) throws InterruptedException, IllegalAccessException, InvocationTargetException, InstantiationException {
        try {
            String[] transportProperties = trpProperties.get();
            for (int i = 0; i < transportMapping.size(); i++) {
                AttributeMapping attributeMapping = transportMapping.get(i);
