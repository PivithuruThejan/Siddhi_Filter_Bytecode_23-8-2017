...
public class PersistenceService {
    ...
    public void restoreRevision(String revision) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        if (persistenceStore != null) {
            if (log.isDebugEnabled()) {
    ...
    public void restoreLastRevision() throws IllegalAccessException, InvocationTargetException, InstantiationException {
        if (persistenceStore != null) {
    ...
    public void restore(byte[] snapshot) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        snapshotService.restore(snapshot);
    }
}
